...
ball_x = 640
ball_y = 360
ball_dx = random.uniform(5, 10)
ball_dy = random.uniform(5, 10)
        ...
        if ball_x < 100:
            if player_1_y < ball_y + 25:
                if player_1_y + 150 > ball_y:
                    ...
                    #collision point player 1
                    collision_point = (ball_y + 25 / 2) - (player_1_y + 150 / 2)
                    collision_point /= 150 / 2

                    #ball direction
                    ball_dx *= -1
                    ball_dy = collision_point * 5
                    bounce_sound_effect.play()
        ...
        if ball_x > 1160:
            if player_2_y < ball_y + 25:
                if player_2_y + 150 > ball_y:
                    ...
                    # collision point player 2
                    collision_point = (ball_y + 25 / 2) - (player_2_y + 150 / 2)
                    collision_point /= 150 / 2

                    # ball direction
                    ball_dx *= random.uniform(1, 5) * -1
                    ball_dy = collision_point * 5
                    bounce_sound_effect.play()

        #the ball have the speed under control
        max_speed = 10
        if abs(ball_dx) > max_speed:
            ball_dx = max_speed if ball_dx > 0 else -max_speed
        if abs(ball_dy) > max_speed:
            ball_dy = max_speed if ball_dy > 0 else -max_speed
